...
> **Advanced Optimization & Data Ontology**: To architect parameters that respect underlying data models, utilize dynamic endpoints, and properly constrain inputs, you **MUST** read [PARAMETER-OPTIMIZATION.md](./PARAMETER-OPTIMIZATION.md) before finalizing widget parameters.
