...
async def get_market_trends(property_id): 
    ...
    async with aiohttp.ClientSession() as session:
        ...
        # 2. Get Fundamentals Trend (5 Mile Radius) 
        # The 'true' flag at the end requests trend data 
        url = f"{base_url}/FundamentalsByRadius/{p_data['lat']}/{p_data['lon']}/5/true?ApiKey={api_key}" 
    ...
    fig.update_layout( 
        title="5-Mile Market Stability (Click & Drag to Zoom)", 
        xaxis=dict( 
